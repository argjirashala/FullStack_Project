    ...
    <div className="view-doctor-view-container">
      <nav className="view-doctor-nav">
        ...
        <Link
          ...
          className={
            location.pathname.includes("set-availability") ? "active" : ""
          }
        >
          Set Availability
        </Link>
        <Link
          ...
          className={
            location.pathname.includes("upcoming-appointments") ? "active" : ""
          }
        >
          Upcoming Appointments
        </Link>
        <Link
          to="/doctor/list-of-appointments"
          className={
            location.pathname.includes("list-of-appointments") ? "active" : ""
          }
        >
        ...
        <button className="view-logout-button" onClick={handleLogout}>
          Logout
        </button>
      </nav>
      ...
      <div className="view-doctor-content">
        <Routes>
          ...
          <Route
            ...
            element={<SetAvailability doctorData={doctorData} />}
          />
          <Route
            path="upcoming-appointments"
            element={<UpcomingAppointments doctorData={doctorData} />}
          />
          <Route
            path="list-of-appointments"
            element={<ListOfAppointments doctorData={doctorData} />}
          />
