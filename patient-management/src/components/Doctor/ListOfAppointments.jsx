...
const ListOfAppointments = ({ doctorData }) => {
  ...
  const handleEditDiagnosisAndTherapy = async () => {
    ...
    try {
      ...
      setSuccessMessage(
        "Diagnosis, therapy, and/or file updated successfully!"
      );
      setErrorMessage("");
      ...
      setErrorMessage(
        "An error occurred while updating the diagnosis, therapy, or file."
      );
      setSuccessMessage("");
    }
  };
  ...
  return (
    <div className="list-appointments-container">
      <h1 className="list-appointments-header">
        List of Appointments for Dr. {doctorData?.surname}
      </h1>
      ...
      <div className="list-search-section">
        ...
        <input
          ...
          onChange={(e) =>
            setSearchCriteria({ ...searchCriteria, personalId: e.target.value })
          }
        />
        <input
          type="date"
        ...
        />
        <button className="list-search-button" onClick={handleSearch}>
          Search
        </button>
      </div>

      {successMessage && (
        <div className="list-success-message">{successMessage}</div>
      )}
      ...
      {selectedAppointment && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            {errorMessage && (
              <div className="list-error-message">{errorMessage}</div>
            )}
            ...
            <div className="modal-buttons">
              <button
                ...
                onClick={handleEditDiagnosisAndTherapy}
              >
                Save
              </button>
              <button
